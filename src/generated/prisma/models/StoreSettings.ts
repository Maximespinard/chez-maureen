...
export type StoreSettingsWhereInput = {
  ...
  key?: Prisma.StringFilter<"StoreSettings"> | string
  value?: Prisma.JsonFilter<"StoreSettings">
...
export type StoreSettingsScalarWhereWithAggregatesInput = {
  ...
  key?: Prisma.StringWithAggregatesFilter<"StoreSettings"> | string
  value?: Prisma.JsonWithAggregatesFilter<"StoreSettings">
...
export type StoreSettingsOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"key" | "value" | "updatedAt", ExtArgs["result"]["storeSettings"]>
...
export interface StoreSettingsDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `key`
   * const storeSettingsWithKeyOnly = await prisma.storeSettings.findMany({ select: { key: true } })
   * 
   */
   ...
   * const storeSettingsWithKeyOnly = await prisma.storeSettings.createManyAndReturn({
   *   select: { key: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * const storeSettingsWithKeyOnly = await prisma.storeSettings.updateManyAndReturn({
   *   select: { key: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface StoreSettingsFieldRefs {
  readonly key: Prisma.FieldRef<"StoreSettings", 'String'>
  readonly value: Prisma.FieldRef<"StoreSettings", 'Json'>
