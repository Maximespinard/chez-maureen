...
interface Product {
  ...
  price: string
  unit?: string
  badges?: Array<{ type: 'new' | 'promo' | 'local' | 'season' | 'bio'; label: string }>
...
const MOCK_PRODUCTS: Array<Product> = [
  ...
  },
  {
    ...
    price: '3.90',
    unit: '/kg',
    badges: [{ type: 'promo', label: '-20%' }, { type: 'local', label: 'Local' }],
    category: 'fruits',
  },
  {
    name: 'Courgettes fraîches',
    image: 'https://images.unsplash.com/photo-1623219300923-11f15f6d7747?w=800&h=600&fit=crop',
  ...
  {
    name: 'Carottes bio',
    image: 'https://images.unsplash.com/photo-1572449831106-34dfb4bd5c20?w=800&h=600&fit=crop',
    origin: 'Suisse',
    price: '2.80',
    unit: '/kg',
    badges: [{ type: 'bio', label: 'Bio' }, { type: 'local', label: 'Local' }],
    category: 'légumes',
  },
  {
    name: 'Bananes',
  ...
  {
    name: 'Salade verte',
    image: 'https://images.unsplash.com/photo-1514517521153-1be72277b32f?w=800&h=600&fit=crop',
    origin: 'Suisse',
    price: '2.50',
    unit: '/pièce',
    badges: [{ type: 'season', label: 'De saison' }, { type: 'local', label: 'Local' }],
    category: 'légumes',
  },
  {
    name: 'Fraises',
    image: 'https://images.unsplash.com/photo-1601493700631-2b16ec4b4716?w=800&h=600&fit=crop',
    origin: 'Suisse',
    price: '8.90',
    unit: '/barquette',
    badges: [{ type: 'season', label: 'De saison' }],
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1599818297538-0e9b21c5b468?w=800&h=600&fit=crop',
    origin: 'Suisse',
    price: '6.50',
    unit: '/250g',
    badges: [{ type: 'local', label: 'Local' }],
  ...
  {
    name: 'Kiwis',
    image: 'https://images.unsplash.com/photo-1519897831810-a9a01aceccd1?w=800&h=600&fit=crop',
  ...
  {
    name: 'Concombres',
    image: 'https://images.unsplash.com/photo-1590165482129-1b8b27698780?w=800&h=600&fit=crop',
    origin: 'Suisse',
    price: '2.90',
    unit: '/pièce',
    badges: [{ type: 'season', label: 'De saison' }],
  ...
  {
    name: 'Basilic frais',
    image: 'https://images.unsplash.com/photo-1628773822503-930a7eaecf80?w=800&h=600&fit=crop',
    origin: 'Suisse',
    price: '3.50',
    unit: '/pot',
    badges: [{ type: 'bio', label: 'Bio' }, { type: 'local', label: 'Local' }],
